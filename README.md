...
### Pasos
 ...
 1-  Clonar el repositorio**
  ...
  2- Configurar el archivo de configuración
       Dentro de la carpeta del proyecto backend (Newsletter/), copia el archivo appsettings.Example.json y renombra la copia a appsettings.json.
       Ese archivo está excluido del repositorio (.gitignore) porque contiene datos sensibles (cadena de conexión, claves, contraseñas), así que cada persona debe crear el suyo local con sus propios valores.

  3- Configurar la Base de Datos
       Abre el archivo appsettings.json que acabas de crear en el proyecto backend.
       Modifica la cadena de conexión (DefaultConnection) para que apunte a tu instancia local de SQL Server.

  4- Abre la Consola del Administrador de Paquetes (Package Manager Console) en Visual Studio y ejecuta:
      PowerShell
